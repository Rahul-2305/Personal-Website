...
<div class="hero">
    ...
    <div>
        ...
        <p>
        A Data Science professional with 1.7+ years of experience in Market Mix Modelling, specializing in multi-linear regression and performance analytics. I translate complex marketing data into clear, revenue-driving decisions — with a growing focus on advanced machine learning and scalable solutions.
        </p>
    </div>
</div>
""", unsafe_allow_html=True)
